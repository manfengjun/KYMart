...
//        let item = UILabel()
//        let width = title.widthForsize(size:CGSize(width: 10000, height: 40),font: 14)
//        item.frame = CGRect(x: 0, y: 0, width: width + 20, height: 38)
//        item.tag = level
...
//        choiceScrollView.addSubview(setuptItem(title: "请选择", level: 1))
//
//        
//    }
